"""Start the local GitPulse Web console."""
...
from gitpulse.config import load_config
...
def run_web(
    *,
    ...
    try:
        ...
        raise RuntimeError("Web 依赖未安装，请重新安装 GitPulse。") from exc
    ...
    console.print("[bold]GitPulse Web 控制台已启动[/bold]\n")
