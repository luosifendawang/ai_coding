...
from gitpulse.models.diff import (
    DiffCollection,
    DiffSource,
    FileChangeStatus,
    FileDiff,
...
from gitpulse.web.services.repository_web_service import RepositoryWebService
...
class HistoryWebService:
    ...
    def _filename(self, filters: dict[str, object], extension: str) -> str:
        ...
        if isinstance(date_from, date) and isinstance(date_to, date):
            ...
            suffix = ""
        return f"gitpulse-history{suffix}.{extension}"
