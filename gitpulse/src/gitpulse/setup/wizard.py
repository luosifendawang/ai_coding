...
from gitpulse.setup.environment import project_config_path, user_config_path
from gitpulse.setup.validators import SetupValidator
...
class SetupWizard:
    """Prepare and optionally write GitPulse config."""

    def __init__(
        self,
        *,
        config: GitPulseConfig | None = None,
