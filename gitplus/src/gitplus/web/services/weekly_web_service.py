...
from gitplus.services.weekly_service import (
...
from gitplus.weekly.cleaner import WeeklyCleanupResult, WeeklyDataCleaner
...
class WeeklyWebService:
    ...
    def export(
        ...
        filename = (
            f"gitplus-weekly-{report.date_range.date_from.isoformat()}-"
